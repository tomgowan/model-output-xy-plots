...
for t in range(200,201):
    ...
    for run in range(1,7):
        ...
        #Plot U-Wind
        wind_plot_xy = ax.contourf(model_run.uinterp[t,t_xy,near:far,left:right].values, levels, cmap = shifted_cmap, extend = 'both', alpha = 1,  zorder = 3)
    ...
    #Save and Close
    plt.savefig("/uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/png_for_gifs/flow_terrain_{:03d}.png".format(t), dpi = 70)
    plt.close(fig)  
